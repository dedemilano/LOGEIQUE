...
def get_result(value, choice = 1):
    ...
    if (choice == 1):
        ...
        try:
            value = int(value)
            landlords_list = list(Landlord.objects.filter(Q(user__username__icontains = value)| Q(user__first_name__icontains=value)| Q(user__last_name__icontains=value)| Q(houses__house_township__icontains=value) |
